# --- JWTCustomAuthentication Code (Identical to resource_manager's version) ---
import jwt
from django.conf import settings
from django.contrib.auth import get_user_model
from django.contrib.auth.models import AnonymousUser
# from django.utils.functional import SimpleLazyObject # Not needed for SimpleUser
...
class JWTCustomAuthentication(authentication.BaseAuthentication):
    def authenticate(self, request):
        ...
        try:
            ...
            # Restituisco sempre un SimpleUser con l'id dal JWT
